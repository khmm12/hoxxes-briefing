...
const EMBLEM_PATH = `M 406 782 L 512 969 L 579 851 L 579 847 Z
...
const GOLD_GRADIENT = `    <linearGradient id="gold" x1="0.18" y1="0.12" x2="0.82" y2="0.88">
...
const GOLD_SHADE_GRADIENT = `    <radialGradient id="goldShade" cx="0.32" cy="0.18" r="0.95">
...
const MARK_ON_PLATE_FILL = '#231d0a'

// Tight viewBox cropping the mark for the bare gold logo (UI + splash source).
const EMBLEM_VIEWBOX_TIGHT = '120 40 792 940'
const EMBLEM_TIGHT_WIDTH = 792
const EMBLEM_TIGHT_HEIGHT = 940
